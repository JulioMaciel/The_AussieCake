...
namespace AussieCake.Question
{
    public class VocModel : QuestionModel
    {
        ...
        public VocModel(int id, string text, string answer, string ptBr, string definition, int importance, int isActive)
            : base(id, text, importance, isActive)
        {
            SetProperties(answer, ptBr, definition);
        }

        public VocModel(string text, string answer, string ptBr, string definition, int importance, int isActive)
