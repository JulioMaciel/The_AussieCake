...
namespace AussieCake.Question
{
    ...
    public partial class Collocations : UserControl
    {
        ...
        private void BuildHeader()
        {
            ...
            MyLbls.Header(wpf.Lbl_imp, 0, 2, grid_insert, SortLbl.Imp, wpf.Cob_imp, filter, stk_items);
            MyBtns.Show_bulk_insert(0, 3, grid_insert, wpf);

            MyTxts.Get(wpf.Txt_words, 1, 0, grid_insert);
            MyTxts.Get(wpf.Txt_answer, 1, 1, grid_insert);
            MyCbBxs.Importance(wpf.Cob_imp, 1, 2, grid_insert, Importance.Any, true);

            MyBtns.Quest_Insert(wpf.Btn_insert, 1, 3, grid_insert, stk_items, wpf);
